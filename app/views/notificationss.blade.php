        ...
        <li{{ ($i % 2 == 1) ? ' class="timeline-inverted"' : '' }}>
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
              <h4 class="timeline-title">New IP Noticed</h4>
              <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> {{ date('d-m-Y @ H:i', strtotime($notification->created_at)); }}</small></p>
            </div>
